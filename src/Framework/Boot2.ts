...
namespace CollegeBoard.Boot2 {
    ...
    export function boot(): void {
        ...
        ngModule = angular.module("CollegeBoard.Application", ["ui.router", "ionic", "templates", "ngMockE2E", "auth0.lock", "angular-jwt","ngLocale"]);
    ...
    function angular_configure(
        ...
        lockProvider.init({
            clientID: Constants.Auth0.AUTH0_CLIENT_ID,
            domain: Constants.Auth0.AUTH0_DOMAIN,
            options: {
                container:Constants.Auth0.AUTHO_CONTAINER_ID,
                auth: {
                    redirect: false,
                    params: {
                        scope: 'openid',
