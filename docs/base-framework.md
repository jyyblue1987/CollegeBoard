...
The base namespace used is `CollegeBoard`. To switch this to your own namespace, you can perform a project find and replace.
...
Angular filters are located in the `src/Filters` directory. To be registered as a filter automatically, a class should exist in the `CollegeBoard.Filters` namespace, and it should contain a unique static ID property and a single static function named `filter`.

```
namespace CollegeBoard.Filters {
...
Angular services are located in the `src/Services` directory. To be registered as a service automatically, a class should exist in the `CollegeBoards.Service` namespace and contain a unique static ID property.
